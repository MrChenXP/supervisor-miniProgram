...
Page({
    ...
    toAdd(e) {
        ...
        if (id) {
            wx.navigateTo({
                url: '/pages/xcdd/xcdd-add/xcdd-add?CONTENT_ID=' + id
            })
        } else {
            wx.navigateTo({
                url: '/pages/xcdd/xcdd-add/xcdd-add'
            })
        }
    },
    // 去预览
    toPreview(e) {
        ...
        if (id) {
            wx.navigateTo({
                url: '/pages/xcdd/xcdd-preview/xcdd-preview?CONTENT_ID=' + id
            })
        }
    },
    // 去整改通知 || 协商意见
    toZgxs(e) {
        ...
        if (status == "2" || status == '3' || status == '5') {
            wx.navigateTo({
                url: "/pages/xcdd/xcdd-zgxs/xcdd-zgxs?status=" + status + "&zgxsId=" + ids
            })
        }
    },
})
